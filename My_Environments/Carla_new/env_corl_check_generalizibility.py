...
def get_fixed_short_straight_path_Town01_2():
    return paths_straight_Town01()[2]
...
class CarlaEnv(Env):
    ...
    def reset(self):
        ...
        if not self.testing:
            ...
            self.source_transform, self.destination_transform = get_fixed_short_straight_path_Town01_2()
