...
class PPOWithVAE(PPO2):
    ...
    def learn(self, total_timesteps, callback=None, seed=None, log_interval=1, tb_log_name="PPO2",
        ...
        self.writer2 = tf.summary.FileWriter('/tmp/ppo/PPO_test', graph=self.graph)
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for update in range(1, nupdates + 1):
                ...
                if update % 2 == 0:
                    ...
                    ob = np.zeros((self.env.num_envs,) + self.env.observation_space.shape)
                    ...
                    summary2 = tf.Summary(value=[tf.Summary.Value(tag="episode_reward", simple_value=total_reward_test)])
